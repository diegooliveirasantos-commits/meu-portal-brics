...
TTL_DADOS_LIVE_SEGUNDOS: int = 300
TTL_DADOS_INTERFACE_SEGUNDOS: int = 120
...
# ==========================================================================
# FILTROS DE MERCADO (APENAS SPOT)
# ==========================================================================
STABLECOINS = [
    "USDC", "BUSD", "DAI", "TUSD", "USDP", "GUSD", "PAX", "UST", "MIM",
    "LUSD", "FRAX", "USDN", "SUSD", "DOLA", "USDD", "CUSD", "USX"
]
...
# ==========================================================================
# DICIONÁRIO DE RESUMOS WYCKOFF (MULTILÍNGUE)
# ==========================================================================
RESUMOS_WYCKOFF = {
    "SPRING": {
...
_TEXTOS_BASE_PT_BR = {
    ...
    "monitorando": "📡 Monitorando os 50 ativos mais líquidos (apenas spot)",
    "top_ativos": "🏆 Top 50 por Volume (24h) - apenas spot",
...
# ==========================================================================
# DICIONÁRIOS DE TRADUÇÃO PARA OS DEMAIS IDIOMAS
# ==========================================================================
_TRADUCOES = {
    ...
    "English (EN)": {
        ...
        "monitorando": "📡 Monitoring the top 50 most liquid assets (spot only)",
        "top_ativos": "🏆 Top 50 by Volume (24h) - spot only",
    ...
    "Español": {
        ...
        "escore_liquido": "Puntuación Neta",
        "plano_trade": "🎯 Plan de Trade",
        "entrada": "Entrada",
        "stop_loss": "STOP LOSS",
        "alvo": "Objetivo",
        "risco_retorno": "Riesgo/Retorno en Objetivo 1",
        "base_stop": "Base del stop",
        "book_titulo": "📊 Libro de Órdenes Agregado",
        "zonas_compra": "MAYORES ZONAS DE COMPRA",
        "zonas_venda": "MAYORES ZONAS DE VENTA",
        "pressao_global": "PRESIÓN GLOBAL DE MERCADO",
        "compra": "COMPRA",
        "venda": "VENTA",
        "desequilibrio": "Desequilibrio",
        "book_equilibrado": "MERCADO EQUILIBRADO",
        "book_comprador": "PRESIÓN COMPRADORA",
        "book_vendedor": "PRESIÓN VENDEDORA",
        "book_indisponivel": "Libro de órdenes no disponible. La puntuación sigue siendo válida.",
        "profundidade": "PROFUNDIDAD AGREGADA (±1,5% del mid)",
        "wyckoff_titulo": "🧭 Estructura Wyckoff",
        "wyckoff_sem_evento": "Ningún evento de Fase C/D identificado en la ventana reciente.",
        "wyckoff_range": "Trading Range",
        "wyckoff_evento": "Evento",
        "wyckoff_fase": "Fase",
        "wyckoff_teste": "Prueba Secundaria",
        "wyckoff_sos": "SOS / SOW",
        "wyckoff_lps": "LPS / LPSY",
        "confirmado": "confirmado",
        "nao_confirmado": "no confirmado",
        "alerta_muralha": "⚠️ Muro de liquidez contraria frente al precio.",
        "valor_memorizado": "último valor conocido",
        "fontes_book": "Exchanges en el book",
        "intervalos": {
            "1 Minuto": "1m", "5 Minutos": "5m", "15 Minutos": "15m", "30 Minutos": "30m",
        ...
        "monitorando": "📡 Monitoreando los 50 activos más líquidos (solo spot)",
        "top_ativos": "🏆 Top 50 por Volumen (24h) - solo spot",
        "horario_brasilia": "🕒 Hora de Brasilia (UTC-3)",
        "telegram_config": "📲 Configuración de Telegram",
        "telegram_status": "Estado de la conexión:",
        "testar_conexao": "🔍 Probar Conexión con Telegram",
        "conectado": "✅ ¡Conexión con Telegram establecida!",
    ...
    "Français": {
        ...
        "escore_liquido": "Score Net",
        "plano_trade": "🎯 Plan de Trade",
        "entrada": "Entrée",
        "stop_loss": "STOP LOSS",
        "alvo": "Cible",
        "risco_retorno": "Risque/Rendement sur Cible 1",
        "base_stop": "Base du stop",
        "book_titulo": "📊 Carnet d'ordres agrégé",
        "zonas_compra": "PLUS GRANDES ZONES D'ACHAT",
        "zonas_venda": "PLUS GRANDES ZONES DE VENTE",
        "pressao_global": "PRESSION GLOBALE DU MARCHÉ",
        "compra": "ACHAT",
        "venda": "VENTE",
        "desequilibrio": "Déséquilibre",
        "book_equilibrado": "MARCHÉ ÉQUILIBRÉ",
        "book_comprador": "PRESSION ACHETEUSE",
        "book_vendedor": "PRESSION VENDEUSE",
        "book_indisponivel": "Carnet d'ordres indisponible. Le score reste valide.",
        "profundidade": "PROFONDEUR AGRÉGÉE (±1,5% du mid)",
        "wyckoff_titulo": "🧭 Structure Wyckoff",
        "wyckoff_sem_evento": "Aucun événement de Phase C/D identifié récemment.",
        "wyckoff_range": "Trading Range",
        "wyckoff_evento": "Événement",
        "wyckoff_fase": "Phase",
        "wyckoff_teste": "Test secondaire",
        "wyckoff_sos": "SOS / SOW",
        "wyckoff_lps": "LPS / LPSY",
        "confirmado": "confirmé",
        "nao_confirmado": "non confirmé",
        "alerta_muralha": "⚠️ Mur de liquidité opposé devant le prix.",
        "valor_memorizado": "dernière valeur connue",
        "fontes_book": "Exchanges dans le book",
        "intervalos": {
            "1 Minute": "1m", "5 Minutes": "5m", "15 Minutes": "15m", "30 Minutes": "30m",
        ...
        "monitorando": "📡 Surveillance des 50 actifs les plus liquides (spot uniquement)",
        "top_ativos": "🏆 Top 50 par Volume (24h) - spot uniquement",
        "horario_brasilia": "🕒 Heure de Brasilia (UTC-3)",
        "telegram_config": "📲 Configuration Telegram",
        "telegram_status": "Statut de la connexion:",
        "testar_conexao": "🔍 Tester la connexion Telegram",
        "conectado": "✅ Connexion Telegram établie !",
    ...
    "Deutsch": {
        ...
        "escore_liquido": "Nettowert",
        "plano_trade": "🎯 Handelsplan",
        "entrada": "Einstieg",
        "stop_loss": "STOP LOSS",
        "alvo": "Ziel",
        "risco_retorno": "Risiko/Rendite bei Ziel 1",
        "base_stop": "Stop-Basis",
        "book_titulo": "📊 Aggregiertes Orderbuch",
        "zonas_compra": "GRÖSSTE KAUFZONEN",
        "zonas_venda": "GRÖSSTE VERKAUFSZONEN",
        "pressao_global": "GLOBALER MARKTDRUCK",
        "compra": "KAUF",
        "venda": "VERKAUF",
        "desequilibrio": "Ungleichgewicht",
        "book_equilibrado": "AUSGEGLICHENER MARKT",
        "book_comprador": "KAUFDRUCK",
        "book_vendedor": "VERKAUFSDRUCK",
        "book_indisponivel": "Orderbuch derzeit nicht verfügbar. Der Score bleibt gültig.",
        "profundidade": "AGGREGIERTE TIEFE (±1,5% des Mid)",
        "wyckoff_titulo": "🧭 Wyckoff-Struktur",
        "wyckoff_sem_evento": "Kein Phase C/D-Ereignis im aktuellen Fenster gefunden.",
        "wyckoff_range": "Trading Range",
        "wyckoff_evento": "Ereignis",
        "wyckoff_fase": "Phase",
        "wyckoff_teste": "Sekundärtest",
        "wyckoff_sos": "SOS / SOW",
        "wyckoff_lps": "LPS / LPSY",
        "confirmado": "bestätigt",
        "nao_confirmado": "nicht bestätigt",
        "alerta_muralha": "⚠️ Erhebliche gegnerische Liquiditätsmauer vor dem Preis.",
        "valor_memorizado": "letzter bekannter Wert",
        "fontes_book": "Börsen im Book",
        "intervalos": {
        ...
        "monitorando": "📡 Überwachung der 50 liquidesten Assets (nur Spot)",
        "top_ativos": "🏆 Top 50 nach Volumen (24h) - nur Spot",
        "horario_brasilia": "🕒 Brasília-Zeit (UTC-3)",
        "telegram_config": "📲 Telegram-Konfiguration",
        "telegram_status": "Verbindungsstatus:",
        "testar_conexao": "🔍 Telegram-Verbindung testen",
        "conectado": "✅ Telegram-Verbindung hergestellt!",
    ...
    "Italiano": {
        ...
        "escore_liquido": "Punteggio Netto",
        "plano_trade": "🎯 Piano di Trade",
        "entrada": "Ingresso",
        "stop_loss": "STOP LOSS",
        "alvo": "Obiettivo",
        "risco_retorno": "Rischio/Rendimento su Obiettivo 1",
        "base_stop": "Base dello stop",
        "book_titulo": "📊 Libro Ordini Aggregato",
        "zonas_compra": "MAGGIORI ZONE DI ACQUISTO",
        "zonas_venda": "MAGGIORI ZONE DI VENDITA",
        "pressao_global": "PRESSIONE GLOBALE DEL MERCATO",
        "compra": "ACQUISTO",
        "venda": "VENDITA",
        "desequilibrio": "Squilibrio",
        "book_equilibrado": "MERCATO EQUILIBRATO",
        "book_comprador": "PRESSIONE ACQUISTATRICE",
        "book_vendedor": "PRESSIONE VENDITRICE",
        "book_indisponivel": "Libro ordini non disponibile al momento. Il punteggio rimane valido.",
        "profundidade": "PROFONDITÀ AGGREGATA (±1,5% del mid)",
        "wyckoff_titulo": "🧭 Struttura Wyckoff",
        "wyckoff_sem_evento": "Nessun evento di Fase C/D identificato nella finestra recente.",
        "wyckoff_range": "Trading Range",
        "wyckoff_evento": "Evento",
        "wyckoff_fase": "Fase",
        "wyckoff_teste": "Test Secondario",
        "wyckoff_sos": "SOS / SOW",
        "wyckoff_lps": "LPS / LPSY",
        "confirmado": "confermato",
        "nao_confirmado": "non confermato",
        "alerta_muralha": "⚠️ Muro di liquidità contraria davanti al prezzo.",
        "valor_memorizado": "ultimo valore noto",
        "fontes_book": "Exchange nel book",
        "intervalos": {
        ...
        "monitorando": "📡 Monitoraggio dei 50 asset più liquidi (solo spot)",
        "top_ativos": "🏆 Top 50 per Volume (24h) - solo spot",
        "horario_brasilia": "🕒 Orario di Brasilia (UTC-3)",
        "telegram_config": "📲 Configurazione Telegram",
        "telegram_status": "Stato connessione:",
        "testar_conexao": "🔍 Testa connessione Telegram",
        "conectado": "✅ Connessione Telegram stabilita!",
    ...
    "Русский": {
        ...
        "escore_liquido": "Чистая оценка",
        "plano_trade": "🎯 План сделки",
        "entrada": "Вход",
        "stop_loss": "СТОП-ЛОСС",
        "alvo": "Цель",
        "risco_retorno": "Риск/Доходность по цели 1",
        "base_stop": "Основа стопа",
        "book_titulo": "📊 Агрегированный стакан заявок",
        "zonas_compra": "КРУПНЕЙШИЕ ЗОНЫ ПОКУПКИ",
        "zonas_venda": "КРУПНЕЙШИЕ ЗОНЫ ПРОДАЖИ",
        "pressao_global": "ГЛОБАЛЬНОЕ ДАВЛЕНИЕ РЫНКА",
        "compra": "ПОКУПКА",
        "venda": "ПРОДАЖА",
        "desequilibrio": "Дисбаланс",
        "book_equilibrado": "СБАЛАНСИРОВАННЫЙ РЫНОК",
        "book_comprador": "ПОКУПАТЕЛЬСКОЕ ДАВЛЕНИЕ",
        "book_vendedor": "ПРОДАВЕЦ ДАВЛЕНИЕ",
        "book_indisponivel": "Стакан заявок временно недоступен. Оценка остается действительной.",
        "profundidade": "АГРЕГИРОВАННАЯ ГЛУБИНА (±1,5% от среднего)",
        "wyckoff_titulo": "🧭 Структура Вайкоффа",
        "wyckoff_sem_evento": "Событие Фазы C/D не обнаружено в последнем окне.",
        "wyckoff_range": "Торговый диапазон",
        "wyckoff_evento": "Событие",
        "wyckoff_fase": "Фаза",
        "wyckoff_teste": "Вторичный тест",
        "wyckoff_sos": "SOS / SOW",
        "wyckoff_lps": "LPS / LPSY",
        "confirmado": "подтверждено",
        "nao_confirmado": "не подтверждено",
        "alerta_muralha": "⚠️ Значительная встречная стена ликвидности перед ценой.",
        "valor_memorizado": "последнее известное значение",
        "fontes_book": "Биржи в стакане",
        "intervalos": {
        ...
        "monitorando": "📡 Мониторинг 50 наиболее ликвидных активов (только спот)",
        "top_ativos": "🏆 Топ-50 по объему (24ч) - только спот",
        "horario_brasilia": "🕒 Время Бразилиа (UTC-3)",
        "telegram_config": "📲 Настройки Telegram",
        "telegram_status": "Статус соединения:",
        "testar_conexao": "🔍 Проверить соединение с Telegram",
        "conectado": "✅ Соединение с Telegram установлено!",
    ...
    "日本語": {
        ...
        "escore_liquido": "ネットスコア",
        "plano_trade": "🎯 トレードプラン",
        "entrada": "エントリー",
        "stop_loss": "ストップロス",
        "alvo": "ターゲット",
        "risco_retorno": "リスク/リターン（ターゲット1）",
        "base_stop": "ストップ基準",
        "book_titulo": "📊 集計オーダーブック",
        "zonas_compra": "最大買いゾーン",
        "zonas_venda": "最大売りゾーン",
        "pressao_global": "グローバルな市場圧力",
        "compra": "買い",
        "venda": "売り",
        "desequilibrio": "不均衡",
        "book_equilibrado": "均衡市場",
        "book_comprador": "買い圧力",
        "book_vendedor": "売り圧力",
        "book_indisponivel": "オーダーブックが利用できません。スコアは有効です。",
        "profundidade": "集計深さ（±1.5% ミッド）",
        "wyckoff_titulo": "🧭 ワイコフ構造",
        "wyckoff_sem_evento": "最近のウィンドウでフェーズC/Dイベントは見つかりませんでした。",
        "wyckoff_range": "トレーディングレンジ",
        "wyckoff_evento": "イベント",
        "wyckoff_fase": "フェーズ",
        "wyckoff_teste": "二次テスト",
        "wyckoff_sos": "SOS / SOW",
        ...
        "confirmado": "確認済み",
        "nao_confirmado": "未確認",
        "alerta_muralha": "⚠️ 価格の前方に重要な対抗流動性の壁があります。",
        "valor_memorizado": "最終既知値",
        "fontes_book": "ブックの取引所",
        "intervalos": {
        ...
        "abaixo": "下",
        "preco_atual": "現在価格",
        "monitorando": "📡 最も流動性の高い50資産を監視中（スポットのみ）",
        "top_ativos": "🏆 出来高トップ50（24h）- スポットのみ",
        "horario_brasilia": "🕒 ブラジリア時間 (UTC-3)",
        "telegram_config": "📲 Telegram設定",
        "telegram_status": "接続ステータス:",
        "testar_conexao": "🔍 Telegram接続テスト",
        "conectado": "✅ Telegram接続確立！",
    ...
    "中文 (简体)": {
        ...
        "stop_loss": "止损",
        "alvo": "目标",
        "risco_retorno": "风险/回报（目标1）",
        "base_stop": "止损基准",
        "book_titulo": "📊 聚合订单簿",
        "zonas_compra": "最大买入区",
        "zonas_venda": "最大卖出区",
        "pressao_global": "全球市场压力",
        "compra": "买入",
        "venda": "卖出",
        "desequilibrio": "失衡",
        "book_equilibrado": "均衡市场",
        "book_comprador": "买入压力",
        "book_vendedor": "卖出压力",
        "book_indisponivel": "订单簿暂时不可用。评分仍然有效。",
        "profundidade": "聚合深度（±1.5% 中间价）",
        "wyckoff_titulo": "🧭 威科夫结构",
        "wyckoff_sem_evento": "最近窗口未发现C/D阶段事件。",
        "wyckoff_range": "交易区间",
        "wyckoff_evento": "事件",
        "wyckoff_fase": "阶段",
        "wyckoff_teste": "二次测试",
        ...
        "confirmado": "已确认",
        "nao_confirmado": "未确认",
        "alerta_muralha": "⚠️ 价格前方存在重大对手流动性墙。",
        "valor_memorizado": "最后已知值",
        "fontes_book": "订单簿中的交易所",
        "intervalos": {
        ...
        "abaixo": "下方",
        "preco_atual": "当前价格",
        "monitorando": "📡 监控50个最具流动性的资产（仅现货）",
        "top_ativos": "🏆 成交量前50（24h）- 仅现货",
        "horario_brasilia": "🕒 巴西利亚时间 (UTC-3)",
        "telegram_config": "📲 Telegram配置",
        "telegram_status": "连接状态：",
        "testar_conexao": "🔍 测试Telegram连接",
        "conectado": "✅ Telegram连接已建立！",
    ...
    "हिन्दी": {
        ...
        "escore_liquido": "शुद्ध स्कोर",
        "plano_trade": "🎯 ट्रेड योजना",
        "entrada": "प्रवेश",
        "stop_loss": "स्टॉप लॉस",
        "alvo": "लक्ष्य",
        "risco_retorno": "जोखिम/रिटर्न (लक्ष्य 1)",
        "base_stop": "स्टॉप आधार",
        "book_titulo": "📊 एकत्रित ऑर्डर बुक",
        "zonas_compra": "सबसे बड़ी खरीद क्षेत्र",
        "zonas_venda": "सबसे बड़ी बिक्री क्षेत्र",
        "pressao_global": "वैश्विक बाजार दबाव",
        "compra": "खरीद",
        "venda": "बिक्री",
        "desequilibrio": "असंतुलन",
        "book_equilibrado": "संतुलित बाजार",
        "book_comprador": "खरीद दबाव",
        "book_vendedor": "बिक्री दबाव",
        "book_indisponivel": "ऑर्डर बुक उपलब्ध नहीं है। स्कोर वैध है।",
        "profundidade": "एकत्रित गहराई (±1.5% मिड)",
        "wyckoff_titulo": "🧭 वायकोफ संरचना",
        "wyckoff_sem_evento": "हालिया विंडो में कोई चरण C/D इवेंट नहीं मिला।",
        "wyckoff_range": "ट्रेडिंग रेंज",
        "wyckoff_evento": "इवेंट",
        "wyckoff_fase": "चरण",
        "wyckoff_teste": "द्वितीयक परीक्षण",
        "wyckoff_sos": "SOS / SOW",
        "wyckoff_lps": "LPS / LPSY",
        "confirmado": "पुष्टि की गई",
        "nao_confirmado": "पुष्टि नहीं हुई",
        "alerta_muralha": "⚠️ कीमत के सामने महत्वपूर्ण विपरीत तरलता दीवार।",
        "valor_memorizado": "अंतिम ज्ञात मान",
        "fontes_book": "बुक में एक्सचेंज",
        "intervalos": {
        ...
        "monitorando": "📡 सबसे अधिक तरल 50 परिसंपत्तियों की निगरानी (केवल स्पॉट)",
        "top_ativos": "🏆 वॉल्यूम द्वारा शीर्ष 50 (24h) - केवल स्पॉट",
        "horario_brasilia": "🕒 ब्रासीलिया समय (UTC-3)",
        "telegram_config": "📲 टेलीग्राम कॉन्फ़िगरेशन",
        "telegram_status": "कनेक्शन स्थिति:",
        "testar_conexao": "🔍 टेलीग्राम कनेक्शन का परीक्षण करें",
        "conectado": "✅ टेलीग्राम कनेक्शन स्थापित!",
...
def obter_resumo_wyckoff(evento_tipo: str, idioma: str) -> str:
    ...
    chave = mapeamento.get(idioma, "pt")
    return RESUMOS_WYCKOFF.get(evento_tipo, {}).get(chave, "Evento Wyckoff detectado")
...
# ==========================================================================
# FUNÇÃO PARA OBTER TODOS OS PARES SPOT DISPONÍVEIS
# ==========================================================================
...
def obter_top_ativos_por_volume(quantidade: int = TOP_ATIVOS_QTD) -> List[str]:
    ...
    try:
        ...
        return top_symbols if top_symbols else [p for p in padrao if is_valid_spot_pair(p)][:quantidade]
    except Exception:
        return [p for p in padrao if is_valid_spot_pair(p)][:quantidade]
...
# ==========================================================================
# FUNÇÕES AUXILIARES (MARKET CAP, TICKER)
# ==========================================================================
...
def painel_principal(simbolo_selecionado: str, timeframe_interface: str, txt: Dict,
    ...
    if modo_vivo:
        ...
        with st.spinner("🔄 Analisando os 50 ativos mais líquidos (apenas spot)..."):
    ...
    with st.sidebar.expander("📲 Configuração do Telegram", expanded=False):
        ...
        if TELEGRAM_TOKEN == "SEU_TOKEN_AQUI" or TELEGRAM_CHAT_ID == "SEU_CHAT_ID_AQUI":
            ...
            if not st.session_state.get("_telegram_initialized", False):
                msg_welcome = "🤖 *BRICSVAULT conectado!*\n\nMonitorando top 50 ativos (apenas spot)."
